...
export default function HomeHero() {
  ...
  useEffect(() => {
    ...
    const applyVideoSrc = (e: MediaQueryList | MediaQueryListEvent) => {
      const src = e.matches
        ? 'https://zljuul74ueozorbo.public.blob.vercel-storage.com/mobileviewherovid.mp4'
        : 'https://zljuul74ueozorbo.public.blob.vercel-storage.com/homepage-hero-section%20.mp4'
  ...
  return (
    <section className="hero">
      <video ref={videoRef} className="hero-video" autoPlay muted loop playsInline>
        <source src="https://zljuul74ueozorbo.public.blob.vercel-storage.com/homepage-hero-section%20.mp4" type="video/mp4" />
      </video>
